...
wrap.innerHTML = '';
      ...
      async function openStudentFullAnalysis(studentId, studentName){
        ...
        try {
          ...
          if(data.aiComment){ html += '<div class="bg-violet-50 rounded-xl border border-violet-200 p-4 mb-4"><div class="font-bold text-sm text-violet-800 mb-2">🤖 AIからのアドバイス</div><div class="text-xs text-slate-700" style="white-space:pre-wrap">'+escH(data.aiComment)+'</div></div>'; }
