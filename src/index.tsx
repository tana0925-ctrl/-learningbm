...
wrap.innerHTML = '';
      ...
      function _buildAiAnalysisText(){
        ...
        L.push('あなたはアプリの修行エリアにいる関西弁の応援キャラ「阪神マン」です。以下の児童の家庭学習データをもとに、①ええところ（取り組みの良い点）②気になるところ③おすすめの学習・声かけ、を関西弁で、子どもが読んで前向きになれるようにやさしくまとめてください。やりすぎず、先生がそのまま使える範囲でお願いします。');
        L.push('');
        L.push('■ 児童: ' + name);
        L.push('');
        L.push('【基本統計】');
