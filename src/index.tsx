...
wrap.innerHTML = '';
      ...
      function _buildAiAnalysisText(){
        ...
        L.push('あなたはアプリの修行エリアにいる関西弁の応援キャラ「阪神マン」です。以下の児童の家庭学習データをもとに、①ええところ（取り組みの良い点）②気になるところ③おすすめの学習・声かけ、を関西弁で、子どもが読んで前向きになれるようにやさしくまとめてください。学年に合わせて声かけを変えること：【下の学年の復習】は「ようがんばって復習できたな！次はいまの学年の◯◯に進もか」、【いまの学年（学年相当）】は出来をしっかりほめる、【先取り（上の学年）】は「まだ習ってへんのにスゴいやん！」と認める。おすすめは具体的に——単元名・つまずきやすいポイント・次の一歩（何を何分やるか）まで書く。下の学年が未定着なら「まず◯年の◯◯を復習→いまの学年へ」と段階で示す。やりすぎず、先生がそのまま児童に渡せる文章にしてください。なお、データが見せる課題は正直に伝えてええ。提出率がひくい・さいきん下がってる・学年そうとうの単元が未定着のときは、ぼかさず具体的に言うたって（例：さいきん提出が◯％に下がってるで）、かならず次の一歩（例：まずは週◯回を目標にしよ）とセットにする。相手は小学生やから、正直でも突き放さず前向きに。ええときは今までどおりしっかりほめる。');
        L.push('');
        L.push('■ 児童: ' + name);
      ...
      async function copyUnifiedAi(){
        ...
        L.push('(2) 続けて各児童ごとに「=== [児童ID] 名前 ===」の行をそのまま残し、その下に阪神マン風（関西弁・前向き）で ①ええところ ②気になるところ ③おすすめの学習・声かけ を、児童本人が読んで前向きになれるように。学年に合わせて声かけを変える。なお、データが見せる課題は正直に伝えてええ。提出率がひくい・さいきん下がってる・学年そうとうの単元が未定着のときは、ぼかさず具体的に言うたって（例：さいきん提出が◯％に下がってるで）、かならず次の一歩（例：まずは週◯回を目標にしよ）とセットにする。相手は小学生やから、正直でも突き放さず前向きに。ええときは今までどおりしっかりほめる。');
        L.push('');
