...
app.get('/', async (c) => {
  try {
    if (!_rootHtmlCache) {
      ...
      // DEF2_LV50_SAME_V1 出陣の 画面で、みんな おなじ ものさしだと つたえる
      t = t.replace(`var enemyHtml='<div style="font-weight:900;margin:6px 0;">👾 敵軍団（`, `var enemyHtml='<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:8px 10px;margin-bottom:8px;color:#1e40af;font-size:12px;font-weight:700;line-height:1.6;">みんな おなじ レベル50 で たたかうよ。かちまけは プログラムの くふうで きまるんだ。</div><div style="font-weight:900;margin:6px 0;">👾 敵軍団（`)
