    ...
    <div class="max-w-5xl mx-auto space-y-4">
      ...
      <div class="grid md:grid-cols-2 gap-4">
        ...
        (function(){
          ...
          if(document.readyState!=='loading') setTimeout(window.rptAdminLoad,300); else document.addEventListener('DOMContentLoaded', function(){ setTimeout(window.rptAdminLoad,300); });
        })();
        </script>
