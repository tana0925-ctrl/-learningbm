...
CREATE INDEX IF NOT EXISTS idx_learning_results_user_time ON learning_results(user_id, created_at);
CREATE INDEX IF NOT EXISTS idx_learning_results_time ON learning_results(created_at);
