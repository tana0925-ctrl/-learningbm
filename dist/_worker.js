var qt=Object.defineProperty;var it=e=>{throw TypeError(e)};var Jt=(e,t,s)=>t in e?qt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var I=(e,t,s)=>Jt(e,typeof t!="symbol"?t+"":t,s),Qe=(e,t,s)=>t.has(e)||it("Cannot "+s);var p=(e,t,s)=>(Qe(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?it("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),E=(e,t,s,a)=>(Qe(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),C=(e,t,s)=>(Qe(e,t,"access private method"),s);var ot=(e,t,s,a)=>({set _(n){E(e,t,n,s)},get _(){return p(e,t,a)}});var dt=(e,t,s)=>(a,n)=>{let r=-1;return i(0);async function i(d){if(d<=r)throw new Error("next() called multiple times");r=d;let l,c=!1,u;if(e[d]?(u=e[d][0][0],a.req.routeIndex=d):u=d===e.length&&n||void 0,u)try{l=await u(a,()=>i(d+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),c=!0;else throw m}else a.finalized===!1&&s&&(l=await s(a));return l&&(a.finalized===!1||c)&&(a.res=l),a}},Kt=Symbol(),$t=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,r=(e instanceof kt?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?zt(e,{all:s,dot:a}):{}};async function zt(e,t){const s=await e.formData();return s?Gt(s,t):{}}function Gt(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Vt(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(Yt(s,a,n),delete s[a])}),s}var Vt=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Yt=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((r,i)=>{i===n.length-1?a[r]=s:((!a[r]||typeof a[r]!="object"||Array.isArray(a[r])||a[r]instanceof File)&&(a[r]=Object.create(null)),a=a[r])})},vt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Zt=e=>{const{groups:t,path:s}=Qt(e),a=vt(s);return Xt(a,t)},Qt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},Xt=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},Pe={},es=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return Pe[a]||(s[2]?Pe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Pe[a]=[e,s[1],!0]),Pe[a]}return null},Ge=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},ts=e=>Ge(e,decodeURI),xt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const r=t.indexOf("?",a),i=t.indexOf("#",a),d=r===-1?i===-1?void 0:i:i===-1?r:Math.min(r,i),l=t.slice(s,d);return ts(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(s,a)},ss=e=>{const t=xt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},fe=(e,t,...s)=>(s.length&&(t=fe(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const r=n.replace("?","");a+="/"+r,s.push(a)}else a+="/"+n}),s.filter((n,r,i)=>i.indexOf(n)===r)},Xe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ge(e,at):e):e,It=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const d=e.charCodeAt(i+t.length+1);if(d===61){const l=i+t.length+2,c=e.indexOf("&",l);return Xe(e.slice(l,c===-1?void 0:c))}else if(d==38||isNaN(d))return"";i=e.indexOf(`&${t}`,i+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const i=e.indexOf("&",r+1);let d=e.indexOf("=",r);d>i&&i!==-1&&(d=-1);let l=e.slice(r+1,d===-1?i===-1?void 0:i:d);if(a&&(l=Xe(l)),r=i,l==="")continue;let c;d===-1?c="":(c=e.slice(d+1,i===-1?void 0:i),a&&(c=Xe(c))),s?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},as=It,ns=(e,t)=>It(e,t,!0),at=decodeURIComponent,lt=e=>Ge(e,at),ye,P,Y,Ct,St,st,Z,gt,kt=(gt=class{constructor(e,t="/",s=[[]]){k(this,Y);I(this,"raw");k(this,ye);k(this,P);I(this,"routeIndex",0);I(this,"path");I(this,"bodyCache",{});k(this,Z,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(r=>(n==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,E(this,P,s),E(this,ye,{})}param(e){return e?C(this,Y,Ct).call(this,e):C(this,Y,St).call(this)}query(e){return as(this.url,e)}queries(e){return ns(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await $t(this,e))}json(){return p(this,Z).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,Z).call(this,"text")}arrayBuffer(){return p(this,Z).call(this,"arrayBuffer")}blob(){return p(this,Z).call(this,"blob")}formData(){return p(this,Z).call(this,"formData")}addValidatedData(e,t){p(this,ye)[e]=t}valid(e){return p(this,ye)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Kt](){return p(this,P)}get matchedRoutes(){return p(this,P)[0].map(([[,e]])=>e)}get routePath(){return p(this,P)[0].map(([[,e]])=>e)[this.routeIndex].path}},ye=new WeakMap,P=new WeakMap,Y=new WeakSet,Ct=function(e){const t=p(this,P)[0][this.routeIndex][1][e],s=C(this,Y,st).call(this,t);return s&&/\%/.test(s)?lt(s):s},St=function(){const e={},t=Object.keys(p(this,P)[0][this.routeIndex][1]);for(const s of t){const a=C(this,Y,st).call(this,p(this,P)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?lt(a):a)}return e},st=function(e){return p(this,P)[1]?p(this,P)[1][e]:e},Z=new WeakMap,gt),rs={Stringify:1},Tt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(n?n[0]+=e:n=[e],Promise.all(r.map(d=>d({phase:t,buffer:n,context:a}))).then(d=>Promise.all(d.filter(Boolean).map(l=>Tt(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},is="text/plain; charset=UTF-8",et=(e,t)=>({"Content-Type":e,...t}),Te=(e,t)=>new Response(e,t),Oe,Le,$,_e,z,B,Ae,ve,xe,oe,Be,je,Q,be,ft,os=(ft=class{constructor(e,t){k(this,Q);k(this,Oe);k(this,Le);I(this,"env",{});k(this,$);I(this,"finalized",!1);I(this,"error");k(this,_e);k(this,z);k(this,B);k(this,Ae);k(this,ve);k(this,xe);k(this,oe);k(this,Be);k(this,je);I(this,"render",(...e)=>(p(this,ve)??E(this,ve,t=>this.html(t)),p(this,ve).call(this,...e)));I(this,"setLayout",e=>E(this,Ae,e));I(this,"getLayout",()=>p(this,Ae));I(this,"setRenderer",e=>{E(this,ve,e)});I(this,"header",(e,t,s)=>{this.finalized&&E(this,B,Te(p(this,B).body,p(this,B)));const a=p(this,B)?p(this,B).headers:p(this,oe)??E(this,oe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});I(this,"status",e=>{E(this,_e,e)});I(this,"set",(e,t)=>{p(this,$)??E(this,$,new Map),p(this,$).set(e,t)});I(this,"get",e=>p(this,$)?p(this,$).get(e):void 0);I(this,"newResponse",(...e)=>C(this,Q,be).call(this,...e));I(this,"body",(e,t,s)=>C(this,Q,be).call(this,e,t,s));I(this,"text",(e,t,s)=>!p(this,oe)&&!p(this,_e)&&!t&&!s&&!this.finalized?new Response(e):C(this,Q,be).call(this,e,t,et(is,s)));I(this,"json",(e,t,s)=>C(this,Q,be).call(this,JSON.stringify(e),t,et("application/json",s)));I(this,"html",(e,t,s)=>{const a=n=>C(this,Q,be).call(this,n,t,et("text/html; charset=UTF-8",s));return typeof e=="object"?Tt(e,rs.Stringify,!1,{}).then(a):a(e)});I(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});I(this,"notFound",()=>(p(this,xe)??E(this,xe,()=>Te()),p(this,xe).call(this,this)));E(this,Oe,e),t&&(E(this,z,t.executionCtx),this.env=t.env,E(this,xe,t.notFoundHandler),E(this,je,t.path),E(this,Be,t.matchResult))}get req(){return p(this,Le)??E(this,Le,new kt(p(this,Oe),p(this,je),p(this,Be))),p(this,Le)}get event(){if(p(this,z)&&"respondWith"in p(this,z))return p(this,z);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,z))return p(this,z);throw Error("This context has no ExecutionContext")}get res(){return p(this,B)||E(this,B,Te(null,{headers:p(this,oe)??E(this,oe,new Headers)}))}set res(e){if(p(this,B)&&e){e=Te(e.body,e);for(const[t,s]of p(this,B).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=p(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}E(this,B,e),this.finalized=!0}get var(){return p(this,$)?Object.fromEntries(p(this,$)):{}}},Oe=new WeakMap,Le=new WeakMap,$=new WeakMap,_e=new WeakMap,z=new WeakMap,B=new WeakMap,Ae=new WeakMap,ve=new WeakMap,xe=new WeakMap,oe=new WeakMap,Be=new WeakMap,je=new WeakMap,Q=new WeakSet,be=function(e,t,s){const a=p(this,B)?new Headers(p(this,B).headers):p(this,oe)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,d]of r)i.toLowerCase()==="set-cookie"?a.append(i,d):a.set(i,d)}if(s)for(const[r,i]of Object.entries(s))if(typeof i=="string")a.set(r,i);else{a.delete(r);for(const d of i)a.append(r,d)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,_e);return Te(e,{status:n,headers:a})},ft),R="ALL",ds="all",ls=["get","post","put","delete","options","patch"],Dt="Can not add a route since the matcher is already built.",Nt=class extends Error{},cs="__COMPOSED_HANDLER",us=e=>e.text("404 Not Found",404),ct=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},F,M,Rt,W,re,We,Ue,Ee,ms=(Ee=class{constructor(t={}){k(this,M);I(this,"get");I(this,"post");I(this,"put");I(this,"delete");I(this,"options");I(this,"patch");I(this,"all");I(this,"on");I(this,"use");I(this,"router");I(this,"getPath");I(this,"_basePath","/");k(this,F,"/");I(this,"routes",[]);k(this,W,us);I(this,"errorHandler",ct);I(this,"onError",t=>(this.errorHandler=t,this));I(this,"notFound",t=>(E(this,W,t),this));I(this,"fetch",(t,...s)=>C(this,M,Ue).call(this,t,s[1],s[0],t.method));I(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${fe("/",t)}`,s),a,n)));I(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(C(this,M,Ue).call(this,t.request,t,void 0,t.request.method))})});[...ls,ds].forEach(r=>{this[r]=(i,...d)=>(typeof i=="string"?E(this,F,i):C(this,M,re).call(this,r,p(this,F),i),d.forEach(l=>{C(this,M,re).call(this,r,p(this,F),l)}),this)}),this.on=(r,i,...d)=>{for(const l of[i].flat()){E(this,F,l);for(const c of[r].flat())d.map(u=>{C(this,M,re).call(this,c.toUpperCase(),p(this,F),u)})}return this},this.use=(r,...i)=>(typeof r=="string"?E(this,F,r):(E(this,F,"*"),i.unshift(r)),i.forEach(d=>{C(this,M,re).call(this,R,p(this,F),d)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??xt:ss}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var i;let r;s.errorHandler===ct?r=n.handler:(r=async(d,l)=>(await dt([],s.errorHandler)(d,()=>n.handler(d,l))).res,r[cs]=n.handler),C(i=a,M,re).call(i,n.method,n.path,r)}),this}basePath(t){const s=C(this,M,Rt).call(this);return s._basePath=fe(this._basePath,t),s}mount(t,s,a){let n,r;a&&(typeof a=="function"?r=a:(r=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const i=r?l=>{const c=r(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=fe(this._basePath,t),c=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,u)}})());const d=async(l,c)=>{const u=await s(n(l.req.raw),...i(l));if(u)return u;await c()};return C(this,M,re).call(this,R,fe(t,"*"),d),this}},F=new WeakMap,M=new WeakSet,Rt=function(){const t=new Ee({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,E(t,W,p(this,W)),t.routes=this.routes,t},W=new WeakMap,re=function(t,s,a){t=t.toUpperCase(),s=fe(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},We=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Ue=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await C(this,M,Ue).call(this,t,s,a,"GET")))();const r=this.getPath(t,{env:a}),i=this.router.match(n,r),d=new os(t,{path:r,matchResult:i,env:a,executionCtx:s,notFoundHandler:p(this,W)});if(i[0].length===1){let c;try{c=i[0][0][0][0](d,async()=>{d.res=await p(this,W).call(this,d)})}catch(u){return C(this,M,We).call(this,u,d)}return c instanceof Promise?c.then(u=>u||(d.finalized?d.res:p(this,W).call(this,d))).catch(u=>C(this,M,We).call(this,u,d)):c??p(this,W).call(this,d)}const l=dt(i[0],this.errorHandler,p(this,W));return(async()=>{try{const c=await l(d);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return C(this,M,We).call(this,c,d)}})()},Ee),Mt=[];function ps(e,t){const s=this.buildAllMatchers(),a=((n,r)=>{const i=s[n]||s[R],d=i[2][r];if(d)return d;const l=r.match(i[0]);if(!l)return[[],Mt];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=a,a(e,t)}var Je="[^/]+",Ne=".*",Re="(?:|/.*)",we=Symbol(),hs=new Set(".\\+*[^]$()");function gs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ne||e===Re?1:t===Ne||t===Re?-1:e===Je?1:t===Je?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var de,le,U,me,fs=(me=class{constructor(){k(this,de);k(this,le);k(this,U,Object.create(null))}insert(t,s,a,n,r){if(t.length===0){if(p(this,de)!==void 0)throw we;if(r)return;E(this,de,s);return}const[i,...d]=t,l=i==="*"?d.length===0?["","",Ne]:["","",Je]:i==="/*"?["","",Re]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let m=l[2]||Je;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw we;if(c=p(this,U)[m],!c){if(Object.keys(p(this,U)).some(f=>f!==Ne&&f!==Re))throw we;if(r)return;c=p(this,U)[m]=new me,u!==""&&E(c,le,n.varIndex++)}!r&&u!==""&&a.push([u,p(c,le)])}else if(c=p(this,U)[i],!c){if(Object.keys(p(this,U)).some(u=>u.length>1&&u!==Ne&&u!==Re))throw we;if(r)return;c=p(this,U)[i]=new me}c.insert(d,s,a,n,r)}buildRegExpStr(){const s=Object.keys(p(this,U)).sort(gs).map(a=>{const n=p(this,U)[a];return(typeof p(n,le)=="number"?`(${a})@${p(n,le)}`:hs.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof p(this,de)=="number"&&s.unshift(`#${p(this,de)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},de=new WeakMap,le=new WeakMap,U=new WeakMap,me),$e,He,bt,bs=(bt=class{constructor(){k(this,$e,{varIndex:0});k(this,He,new fs)}insert(e,t,s){const a=[],n=[];for(let i=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,d=!0,c}),!d)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[d]=n[i];for(let l=r.length-1;l>=0;l--)if(r[l].indexOf(d)!==-1){r[l]=r[l].replace(d,n[i][1]);break}}return p(this,He).insert(r,t,a,p(this,$e),s),a}buildRegExp(){let e=p(this,He).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,r,i)=>r!==void 0?(s[++t]=Number(r),"$()"):(i!==void 0&&(a[Number(i)]=++t),"")),[new RegExp(`^${e}`),s,a]}},$e=new WeakMap,He=new WeakMap,bt),ws=[/^$/,[],Object.create(null)],qe=Object.create(null);function Ot(e){return qe[e]??(qe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ys(){qe=Object.create(null)}function _s(e){var c;const t=new bs,s=[];if(e.length===0)return ws;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[f,w])=>u?1:f?-1:m.length-w.length),n=Object.create(null);for(let u=0,m=-1,f=a.length;u<f;u++){const[w,g,y]=a[u];w?n[g]=[y.map(([v])=>[v,Object.create(null)]),Mt]:m++;let b;try{b=t.insert(g,m,w)}catch(v){throw v===we?new Nt(g):v}w||(s[m]=y.map(([v,_])=>{const x=Object.create(null);for(_-=1;_>=0;_--){const[T,D]=b[_];x[T]=D}return[v,x]}))}const[r,i,d]=t.buildRegExp();for(let u=0,m=s.length;u<m;u++)for(let f=0,w=s[u].length;f<w;f++){const g=(c=s[u][f])==null?void 0:c[1];if(!g)continue;const y=Object.keys(g);for(let b=0,v=y.length;b<v;b++)g[y[b]]=d[g[y[b]]]}const l=[];for(const u in i)l[u]=s[i[u]];return[r,l,n]}function ge(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Ot(s).test(t))return[...e[s]]}}var X,ee,ze,Lt,wt,vs=(wt=class{constructor(){k(this,ze);I(this,"name","RegExpRouter");k(this,X);k(this,ee);I(this,"match",ps);E(this,X,{[R]:Object.create(null)}),E(this,ee,{[R]:Object.create(null)})}add(e,t,s){var d;const a=p(this,X),n=p(this,ee);if(!a||!n)throw new Error(Dt);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[R]).forEach(c=>{l[e][c]=[...l[R][c]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Ot(t);e===R?Object.keys(a).forEach(c=>{var u;(u=a[c])[t]||(u[t]=ge(a[c],t)||ge(a[R],t)||[])}):(d=a[e])[t]||(d[t]=ge(a[e],t)||ge(a[R],t)||[]),Object.keys(a).forEach(c=>{(e===R||e===c)&&Object.keys(a[c]).forEach(u=>{l.test(u)&&a[c][u].push([s,r])})}),Object.keys(n).forEach(c=>{(e===R||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([s,r]))});return}const i=Et(t)||[t];for(let l=0,c=i.length;l<c;l++){const u=i[l];Object.keys(n).forEach(m=>{var f;(e===R||e===m)&&((f=n[m])[u]||(f[u]=[...ge(a[m],u)||ge(a[R],u)||[]]),n[m][u].push([s,r-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,ee)).concat(Object.keys(p(this,X))).forEach(t=>{e[t]||(e[t]=C(this,ze,Lt).call(this,t))}),E(this,X,E(this,ee,void 0)),ys(),e}},X=new WeakMap,ee=new WeakMap,ze=new WeakSet,Lt=function(e){const t=[];let s=e===R;return[p(this,X),p(this,ee)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(r=>[r,a[e][r]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==R&&t.push(...Object.keys(a[R]).map(r=>[r,a[R][r]]))}),s?_s(t):null},wt),te,G,yt,xs=(yt=class{constructor(e){I(this,"name","SmartRouter");k(this,te,[]);k(this,G,[]);E(this,te,e.routers)}add(e,t,s){if(!p(this,G))throw new Error(Dt);p(this,G).push([e,t,s])}match(e,t){if(!p(this,G))throw new Error("Fatal error");const s=p(this,te),a=p(this,G),n=s.length;let r=0,i;for(;r<n;r++){const d=s[r];try{for(let l=0,c=a.length;l<c;l++)d.add(...a[l]);i=d.match(e,t)}catch(l){if(l instanceof Nt)continue;throw l}this.match=d.match.bind(d),E(this,te,[d]),E(this,G,void 0);break}if(r===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(p(this,G)||p(this,te).length!==1)throw new Error("No active router has been determined yet.");return p(this,te)[0]}},te=new WeakMap,G=new WeakMap,yt),De=Object.create(null),Es=e=>{for(const t in e)return!0;return!1},se,L,ce,Ie,O,V,ie,ke,Is=(ke=class{constructor(t,s,a){k(this,V);k(this,se);k(this,L);k(this,ce);k(this,Ie,0);k(this,O,De);if(E(this,L,a||Object.create(null)),E(this,se,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},E(this,se,[n])}E(this,ce,[])}insert(t,s,a){E(this,Ie,++ot(this,Ie)._);let n=this;const r=Zt(s),i=[];for(let d=0,l=r.length;d<l;d++){const c=r[d],u=r[d+1],m=es(c,u),f=Array.isArray(m)?m[0]:c;if(f in p(n,L)){n=p(n,L)[f],m&&i.push(m[1]);continue}p(n,L)[f]=new ke,m&&(p(n,ce).push(m),i.push(m[1])),n=p(n,L)[f]}return p(n,se).push({[t]:{handler:a,possibleKeys:i.filter((d,l,c)=>c.indexOf(d)===l),score:p(this,Ie)}}),n}search(t,s){var u;const a=[];E(this,O,De);let r=[this];const i=vt(s),d=[],l=i.length;let c=null;for(let m=0;m<l;m++){const f=i[m],w=m===l-1,g=[];for(let b=0,v=r.length;b<v;b++){const _=r[b],x=p(_,L)[f];x&&(E(x,O,p(_,O)),w?(p(x,L)["*"]&&C(this,V,ie).call(this,a,p(x,L)["*"],t,p(_,O)),C(this,V,ie).call(this,a,x,t,p(_,O))):g.push(x));for(let T=0,D=p(_,ce).length;T<D;T++){const H=p(_,ce)[T],A=p(_,O)===De?{}:{...p(_,O)};if(H==="*"){const pe=p(_,L)["*"];pe&&(C(this,V,ie).call(this,a,pe,t,p(_,O)),E(pe,O,A),g.push(pe));continue}const[Ye,rt,Ce]=H;if(!f&&!(Ce instanceof RegExp))continue;const K=p(_,L)[Ye];if(Ce instanceof RegExp){if(c===null){c=new Array(l);let he=s[0]==="/"?1:0;for(let Se=0;Se<l;Se++)c[Se]=he,he+=i[Se].length+1}const pe=s.substring(c[m]),Ze=Ce.exec(pe);if(Ze){if(A[rt]=Ze[0],C(this,V,ie).call(this,a,K,t,p(_,O),A),Es(p(K,L))){E(K,O,A);const he=((u=Ze[0].match(/\//))==null?void 0:u.length)??0;(d[he]||(d[he]=[])).push(K)}continue}}(Ce===!0||Ce.test(f))&&(A[rt]=f,w?(C(this,V,ie).call(this,a,K,t,A,p(_,O)),p(K,L)["*"]&&C(this,V,ie).call(this,a,p(K,L)["*"],t,A,p(_,O))):(E(K,O,A),g.push(K)))}}const y=d.shift();r=y?g.concat(y):g}return a.length>1&&a.sort((m,f)=>m.score-f.score),[a.map(({handler:m,params:f})=>[m,f])]}},se=new WeakMap,L=new WeakMap,ce=new WeakMap,Ie=new WeakMap,O=new WeakMap,V=new WeakSet,ie=function(t,s,a,n,r){for(let i=0,d=p(s,se).length;i<d;i++){const l=p(s,se)[i],c=l[a]||l[R],u={};if(c!==void 0&&(c.params=Object.create(null),t.push(c),n!==De||r&&r!==De))for(let m=0,f=c.possibleKeys.length;m<f;m++){const w=c.possibleKeys[m],g=u[c.score];c.params[w]=r!=null&&r[w]&&!g?r[w]:n[w]??(r==null?void 0:r[w]),u[c.score]=!0}}},ke),ue,_t,ks=(_t=class{constructor(){I(this,"name","TrieRouter");k(this,ue);E(this,ue,new Is)}add(e,t,s){const a=Et(t);if(a){for(let n=0,r=a.length;n<r;n++)p(this,ue).insert(e,a[n],s);return}p(this,ue).insert(e,t,s)}match(e,t){return p(this,ue).search(e,t)}},ue=new WeakMap,_t),At=class extends ms{constructor(e={}){super(e),this.router=e.router??new xs({routers:[new vs,new ks]})}},Cs=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(r=>typeof r=="string"?r==="*"?()=>r:i=>r===i?i:null:typeof r=="function"?r:i=>r.includes(i)?i:null)(s.origin),n=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(s.allowMethods);return async function(i,d){var u;function l(m,f){i.res.headers.set(m,f)}const c=await a(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),s.credentials&&l("Access-Control-Allow-Credentials","true"),(u=s.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),i.req.method==="OPTIONS"){s.origin!=="*"&&l("Vary","Origin"),s.maxAge!=null&&l("Access-Control-Max-Age",s.maxAge.toString());const m=await n(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let f=s.allowHeaders;if(!(f!=null&&f.length)){const w=i.req.header("Access-Control-Request-Headers");w&&(f=w.split(/\s*,\s*/))}return f!=null&&f.length&&(l("Access-Control-Allow-Headers",f.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await d(),s.origin!=="*"&&i.header("Vary","Origin",{append:!0})}},Ss=/^[\w!#$%&'*.^`|~+-]+$/,Ts=/^[ !#-:<-[\]-~]*$/,Ds=(e,t)=>{if(t&&e.indexOf(t)===-1)return{};const s=e.trim().split(";"),a={};for(let n of s){n=n.trim();const r=n.indexOf("=");if(r===-1)continue;const i=n.substring(0,r).trim();if(t&&t!==i||!Ss.test(i))continue;let d=n.substring(r+1).trim();if(d.startsWith('"')&&d.endsWith('"')&&(d=d.slice(1,-1)),Ts.test(d)&&(a[i]=d.indexOf("%")!==-1?Ge(d,at):d,t))break}return a},Ns=(e,t,s={})=>{let a=`${e}=${t}`;if(e.startsWith("__Secure-")&&!s.secure)throw new Error("__Secure- Cookie must have Secure attributes");if(e.startsWith("__Host-")){if(!s.secure)throw new Error("__Host- Cookie must have Secure attributes");if(s.path!=="/")throw new Error('__Host- Cookie must have Path attributes with "/"');if(s.domain)throw new Error("__Host- Cookie must not have Domain attributes")}if(s&&typeof s.maxAge=="number"&&s.maxAge>=0){if(s.maxAge>3456e4)throw new Error("Cookies Max-Age SHOULD NOT be greater than 400 days (34560000 seconds) in duration.");a+=`; Max-Age=${s.maxAge|0}`}if(s.domain&&s.prefix!=="host"&&(a+=`; Domain=${s.domain}`),s.path&&(a+=`; Path=${s.path}`),s.expires){if(s.expires.getTime()-Date.now()>3456e7)throw new Error("Cookies Expires SHOULD NOT be greater than 400 days (34560000 seconds) in the future.");a+=`; Expires=${s.expires.toUTCString()}`}if(s.httpOnly&&(a+="; HttpOnly"),s.secure&&(a+="; Secure"),s.sameSite&&(a+=`; SameSite=${s.sameSite.charAt(0).toUpperCase()+s.sameSite.slice(1)}`),s.priority&&(a+=`; Priority=${s.priority.charAt(0).toUpperCase()+s.priority.slice(1)}`),s.partitioned){if(!s.secure)throw new Error("Partitioned Cookie must have Secure attributes");a+="; Partitioned"}return a},tt=(e,t,s)=>(t=encodeURIComponent(t),Ns(e,t,s)),Bt=(e,t,s)=>{const a=e.req.raw.headers.get("Cookie");{if(!a)return;let n=t;return s==="secure"?n="__Secure-"+t:s==="host"&&(n="__Host-"+t),Ds(a,n)[n]}},Rs=(e,t,s)=>{let a;return(s==null?void 0:s.prefix)==="secure"?a=tt("__Secure-"+e,t,{path:"/",...s,secure:!0}):(s==null?void 0:s.prefix)==="host"?a=tt("__Host-"+e,t,{...s,path:"/",secure:!0,domain:void 0}):a=tt(e,t,{path:"/",...s}),a},jt=(e,t,s,a)=>{const n=Rs(t,s,a);e.header("Set-Cookie",n,{append:!0})},Me=(e,t,s)=>{const a=Bt(e,t,s==null?void 0:s.prefix);return jt(e,t,"",{...s,maxAge:0}),a};const h=new At;h.onError((e,t)=>{console.error("Unhandled error:",e);const s=e instanceof Error?`${e.name}: ${e.message}`:String(e);return t.text(`Internal Error
${s}`,500)});h.use("/api/*",Cs({origin:e=>e?e.endsWith(".pages.dev")||e==="http://localhost:8788"||e==="http://127.0.0.1:8788"?e:null:"*",credentials:!0}));const Fe=new Map;let ut=0;function Ht(e,t,s){const a=Date.now();if(a-ut>6e4){ut=a;for(const[r,i]of Fe)a>i.resetAt&&Fe.delete(r)}let n=Fe.get(e);return(!n||a>n.resetAt)&&(n={count:0,resetAt:a+s*1e3},Fe.set(e,n)),n.count++,!(n.count>t)}function o(e,t,s){return e.json({ok:!1,error:s},t)}function nt(e){const t=new Uint8Array(e);let s="";for(let a=0;a<t.length;a++)s+=String.fromCharCode(t[a]);return btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}function Pt(e){for(e=e.replace(/-/g,"+").replace(/_/g,"/");e.length%4;)e+="=";const t=atob(e),s=new Uint8Array(t.length);for(let a=0;a<t.length;a++)s[a]=t.charCodeAt(a);return s}async function Ms(e,t){const s=new TextEncoder,a=await crypto.subtle.importKey("raw",s.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("HMAC",a,s.encode(t));return nt(n)}async function Os(e,t,s){const a=new TextEncoder,n=await crypto.subtle.importKey("raw",a.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["verify"]);return crypto.subtle.verify("HMAC",n,Pt(s),a.encode(t))}function ae(e=16){const t=new Uint8Array(e);return crypto.getRandomValues(t),[...t].map(s=>s.toString(16).padStart(2,"0")).join("")}async function ne(e,t,s=1e5){const a=new TextEncoder,n=new Uint8Array(t.match(/.{1,2}/g).map(d=>parseInt(d,16))),r=await crypto.subtle.importKey("raw",a.encode(e),"PBKDF2",!1,["deriveBits"]),i=await crypto.subtle.deriveBits({name:"PBKDF2",hash:"SHA-256",salt:n,iterations:s},r,256);return nt(i)}async function Ls(e,t){const s=nt(new TextEncoder().encode(JSON.stringify(t))),a=await Ms(e,s);return`v1.${s}.${a}`}async function As(e,t){const s=t.split(".");if(s.length!==3||s[0]!=="v1")return null;const a=s[1],n=s[2];if(!await Os(e,a,n))return null;const i=new TextDecoder().decode(Pt(a));return JSON.parse(i)}h.use("*",async(e,t)=>{const s=e.env.ADMIN_LOGIN_ID||"",a=e.env.ADMIN_PASSWORD||"",n=e.env.SESSION_SECRET;if(!s||!a||!n)return t();if(!await e.env.DB.prepare("SELECT id FROM users WHERE role='admin' AND login_id=? LIMIT 1").bind(s).first()){const i=crypto.randomUUID(),d=ae(16),l=await ne(a,d);await e.env.DB.prepare(`INSERT INTO users (id, role, login_id, password_hash, password_salt, name, grade, class_name, is_active)
     ...
     FROM users WHERE login_id = ? LIMIT 1`).bind(s).first();if(!n){const d=await e.env.DB.prepare(`SELECT id, 'teacher' as role, login_id as loginId, password_hash as hash, password_salt as salt,
       ...
       ON CONFLICT(user_id) DO UPDATE SET state_json=excluded.state_json, updated_at=datetime('now')`).bind(t.id,a).run()}catch(n){return console.error("[progress] DB error:",(n==null?void 0:n.message)||n),o(e,500,"db_error")}try{const n=await e.env.DB.prepare("SELECT name, grade FROM users WHERE id=? LIMIT 1").bind(t.id).first(),r=Hs(a,(n==null?void 0:n.name)||""),i=Number((n==null?void 0:n.grade)||0),d=Ft(),l=await e.env.DB.prepare("SELECT week_start, correct_count, total_level, battle_power, pokedex_count, wild_win_streak, ranking_points FROM ranking_stats WHERE user_id=? LIMIT 1").bind(t.id).first();let c=0,u=0,m=0,f=0,w=0,g=0;l&&l.week_start===d||l&&(c=Number(l.correct_count||0),u=Number(l.total_level||0),m=Number(l.battle_power||0),f=Number(l.pokedex_count||0),w=Number(l.wild_win_streak||0),g=Number(l.ranking_points||0)),l?l.week_start!==d?await e.env.DB.prepare(`UPDATE ranking_stats SET
         ...
         WHERE user_id=?`).bind(r.displayName,r.totalLevel,r.monsterCount,r.correctCount,r.rankingPoints,i,r.battlePower,r.pokedexCount,r.wildWinStreak,d,c,u,m,f,w,g,t.id).run():await e.env.DB.prepare(`UPDATE ranking_stats SET
           display_name=?, total_level=?, monster_count=?, correct_count=?, ranking_points=?,
           grade=?, battle_power=?, pokedex_count=?, wild_win_streak=?,
           updated_at=datetime('now')
...
`),{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":'attachment; filename="learning_results.csv"'}})});h.get("/api/admin/pending-teachers",async e=>{if(!S(e))return o(e,401,"unauthorized");const s=await e.env.DB.prepare("SELECT id, login_id as loginId, name, school, created_at as createdAt FROM teacher_accounts WHERE is_active=0 ORDER BY created_at DESC").all();return e.json({ok:!0,teachers:s.results})});h.post("/api/admin/approve-teacher/:id",async e=>S(e)?(await e.env.DB.prepare("UPDATE teacher_accounts SET is_active=1 WHERE id=?").bind(e.req.param("id")).run(),e.json({ok:!0})):o(e,401,"unauthorized"));h.delete("/api/admin/reject-teacher/:id",async e=>S(e)?(await e.env.DB.prepare("DELETE FROM teacher_accounts WHERE id=? AND is_active=0").bind(e.req.param("id")).run(),e.json({ok:!0})):o(e,401,"unauthorized"));h.get("/api/admin/teachers",async e=>{if(!S(e))return o(e,401,"unauthorized");const s=await e.env.DB.prepare(`SELECT id, login_id as loginId, name, school, is_active as isActive, last_login_at as lastLoginAt, created_at as createdAt
  ...
  `).bind(s).all();return e.json({ok:!0,class:a,members:n.results})});h.get("/api/teacher/class/:classId/unit-analytics",async e=>{var c,u,m,f,w;const t=N(e);if(!t)return o(e,401,"unauthorized");const s=e.req.param("classId"),a=t.role==="admin"?await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? AND teacher_id=? LIMIT 1").bind(s,t.id).first();if(!a)return o(e,404,"class_not_found");const n=await e.env.DB.prepare(`
    ...
    WHERE cm.class_id = ?
    ORDER BY u.name
  `).bind(s).all(),r=[],i=new Map;for(const g of n.results){let y={},b={},v=0;try{if(g.stateJson){const _=JSON.parse(g.stateJson);y=((u=(c=_==null?void 0:_.metrics)==null?void 0:c.learn)==null?void 0:u.byUnit)||{},b=((f=(m=_==null?void 0:_.metrics)==null?void 0:m.learn)==null?void 0:f.bySubject)||{};const x=((w=_==null?void 0:_.metrics)==null?void 0:w.daily)||{},T=Object.keys(x).filter(H=>{var A;return(((A=x[H])==null?void 0:A.training)||0)>=1}).sort();let D=0;for(let H=T.length-1;H>=0;H--){const A=new Date(T[H]+"T00:00:00+09:00");if(Math.round((Date.now()-A.getTime())/864e5)===T.length-1-H)D++;else break}v=D}}catch{}Object.keys(y).forEach(_=>{const x=y[_];!i.has(_)&&x.unitName&&i.set(_,{name:x.unitName,subject:x.subjectName||""})}),r.push({id:g.id,name:g.name||"",grade:g.grade||"",byUnit:y,bySubject:b,learnStreak:v})}const d=[];i.forEach((g,y)=>{r.some(b=>{var v;return(((v=b.byUnit[y])==null?void 0:v.total)||0)>=5})&&d.push(y)});const l=d.map(g=>{const y=i.get(g),b=r.filter(x=>{var T;return(((T=x.byUnit[g])==null?void 0:T.total)||0)>=5}),v=b.reduce((x,T)=>{const D=T.byUnit[g];return x+(D.total?D.correct/D.total:0)},0),_=b.length>0?Math.round(v/b.length*100):null;return{mode:g,name:y.name,subject:y.subject,classAvg:_,studentCount:b.length}}).sort((g,y)=>(g.classAvg??101)-(y.classAvg??101));return e.json({ok:!0,class:a,unitSummary:l,unitInfo:Object.fromEntries(i),students:r.map(g=>({id:g.id,name:g.name,grade:g.grade,learnStreak:g.learnStreak,bySubject:Object.fromEntries(Object.entries(g.bySubject).map(([y,b])=>[y,{total:b.total||0,correct:b.correct||0,acc:b.total?Math.round(b.correct/b.total*100):0}])),units:Object.fromEntries(d.map(y=>{const b=g.byUnit[y];return!b||(b.total||0)<5?[y,null]:[y,{total:b.total,correct:b.correct,acc:Math.round(b.correct/b.total*100)}]}))}))})});h.get("/api/teacher/class/:classId/activity",async e=>{const t=N(e);if(!t)return o(e,401,"unauthorized");const s=e.req.param("classId"),a=t.role==="admin"?await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? AND teacher_id=? LIMIT 1").bind(s,t.id).first();if(!a)return o(e,404,"class_not_found");const n=await e.env.DB.prepare(`SELECT u.id, u.name, u.last_login_at as lastLoginAt
     ...
     WHERE r.answered_at >= datetime('now', '-24 hours')`).bind(s).all(),i=new Set(r.results.map(f=>f.userId)),d=r.results.length,l=r.results.filter(f=>f.isCorrect).length,c=d>0?Math.round(l/d*100):null,u=await e.env.DB.prepare(`SELECT r.answered_at as answeredAt, r.unit, r.is_correct as isCorrect, r.time_ms as timeMs,
            u.name, u.login_id as loginId
     FROM learning_results r
     JOIN class_members cm ON cm.user_id = r.user_id AND cm.class_id = ?
     JOIN users u ON u.id = r.user_id
     ORDER BY r.answered_at DESC LIMIT 50`).bind(s).all(),m=n.results.filter(f=>{if(!f.lastLoginAt)return!0;const w=new Date(f.lastLoginAt+"Z");return Date.now()-w.getTime()>7*864e5}).map(f=>({id:f.id,name:f.name,lastLoginAt:f.lastLoginAt}));return e.json({ok:!0,class:a,summary:{memberCount:n.results.length,activeToday:i.size,totalProblems:d,accuracy:c},recentLog:u.results,inactive:m})});h.get("/api/teacher/class-ai-analysis",async e=>{const t=N(e);if(!t)return o(e,401,"unauthorized");const s=e.req.query("classId");if(!s)return o(e,400,"classId required");const a=t.role==="admin"?await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id, name FROM classes WHERE id=? AND teacher_id=? LIMIT 1").bind(s,t.id).first();if(!a)return o(e,404,"class_not_found");const n=await e.env.DB.prepare(`
    SELECT u.id, u.name, p.state_json
    FROM class_members cm JOIN users u ON u.id = cm.user_id
    LEFT JOIN progress p ON p.user_id = cm.user_id
    WHERE cm.class_id = ?
  `).bind(s).all(),r=e.req.query("weekKey")||"";let i={results:[]},d={results:[]},l={results:[]};try{i=await e.env.DB.prepare("SELECT user_id, subject, minutes, created_at FROM homework_logs WHERE class_id = ? AND week_key = ?").bind(s,r).all()}catch{}try{d=await e.env.DB.prepare("SELECT user_id, goal_text, plan_text, revision_count FROM weekly_plans WHERE class_id = ? AND week_key = ?").bind(s,r).all()}catch{}try{l=await e.env.DB.prepare("SELECT user_id, reflection_text, concentration, achievement FROM weekly_reflections WHERE class_id = ? AND week_key = ?").bind(s,r).all()}catch{}const c=n.results.map(m=>{var b,v;const f=i.results.filter(_=>_.user_id===m.id),w=d.results.find(_=>_.user_id===m.id),g=l.results.find(_=>_.user_id===m.id);let y={};try{if(m.state_json){const _=JSON.parse(m.state_json),x=((v=(b=_==null?void 0:_.metrics)==null?void 0:b.learn)==null?void 0:v.bySubject)||{};y=Object.fromEntries(Object.entries(x).map(([T,D])=>[T,{total:D.total||0,correct:D.correct||0,acc:D.total?Math.round(D.correct/D.total*100):0}]))}}catch{}return{name:m.name,homework:{count:f.length,totalMinutes:f.reduce((_,x)=>_+(x.minutes||0),0),subjects:f.map(_=>_.subject)},plan:w?{goal:w.goal_text,plan:w.plan_text,revisions:w.revision_count}:null,reflection:g?{text:g.reflection_text,concentration:g.concentration,achievement:g.achievement}:null,learning:y}}),u=["あなたは小学校の教師を支援するAIアシスタントです。以下は"+a.name+"の今週（"+r+"）の学習データです。","クラス人数: "+n.results.length+"人","","【児童別データ】",...c.map(m=>{let f="■ "+m.name+": 家庭学習"+m.homework.count+"回("+m.homework.totalMinutes+"分)";return m.plan&&(f+=", 計画あり(修正"+m.plan.revisions+"回)"),m.reflection&&(f+=", ふりかえりあり(集中度"+m.reflection.concentration+")"),Object.keys(m.learning).length>0&&(f+=", 教科別正答率: "+Object.entries(m.learning).map(([w,g])=>w+g.acc+"%").join("/")),f}),"","以下の観点で分析してください：","1. 家庭学習の傾向: クラス全体の提出状況、学習時間の傾向","2. 困りごとの検出: 学習量が少ない・正答率が低い・未提出の児童を特定","3. 自己調整の力: 計画→実行→ふりかえりのサイクルができている児童、支援が必要な児童","4. 具体的なアドバイス: 教師として来週どんな声かけや支援をすべきか","","日本語で、箇条書きではなく教師に語りかけるような文章で回答してください。"].join(`
`);try{const m=await e.env.AI.run("@cf/meta/llama-3.1-8b-instruct",{messages:[{role:"user",content:u}],max_tokens:1024});return e.json({ok:!0,analysis:m.response||m.result||""})}catch(m){return e.json({ok:!1,error:m.message||"AI error"},500)}});h.post("/api/student/join-class",async e=>{const t=q(e);if(!t)return o(e,401,"unauthorized");const s=await e.req.json().catch(()=>null);if(!s)return o(e,400,"invalid_json");const a=String(s.classCode||"").trim().toUpperCase();if(!a)return o(e,400,"code_required");const n=await e.env.DB.prepare("SELECT id, name FROM classes WHERE class_code=? LIMIT 1").bind(a).first();return n?(await e.env.DB.prepare("SELECT 1 FROM class_members WHERE user_id=? AND class_id=? LIMIT 1").bind(t.id,n.id).first()||(await e.env.DB.prepare("DELETE FROM class_members WHERE user_id=?").bind(t.id).run(),await e.env.DB.prepare("INSERT INTO class_members (user_id, class_id) VALUES (?, ?)").bind(t.id,n.id).run()),e.json({ok:!0,className:n.name})):o(e,404,"class_not_found")});h.get("/api/student/class-info",async e=>{const t=q(e);if(!t)return o(e,401,"unauthorized");const s=await e.env.DB.prepare(`
  ...
  `).bind(t.id).first();return e.json({ok:!0,class:s||null})});h.post("/api/student/leave-class",async e=>{const t=q(e);return t?(await e.env.DB.prepare("DELETE FROM class_members WHERE user_id=?").bind(t.id).run(),e.json({ok:!0})):o(e,401,"unauthorized")});h.get("/api/ranking",async e=>{const t=e.get("user");if(!t)return o(e,401,"unauthorized");const s=await e.env.DB.prepare("SELECT value FROM admin_settings WHERE key='ranking_scope' LIMIT 1").first(),a=await e.env.DB.prepare("SELECT value FROM admin_settings WHERE key='ranking_enabled' LIMIT 1").first(),n=(s==null?void 0:s.value)||"class",r=(a==null?void 0:a.value)!=="0";if(!r||n==="hidden")return e.json({ok:!0,ranking:[],scope:n,enabled:!1,hidden:!0});const i=e.req.query("type")||"overall",d=e.req.query("period")||"cumulative",l=Number(e.req.query("grade")||0),c=Ft();let u="rs.total_level",m="";switch(i){case"overall":u="rs.total_level";break;case"power":u="rs.battle_power";break;case"correct":u="rs.ranking_points";break;case"pokedex":u="rs.pokedex_count";break;case"wild":u="rs.wild_win_streak";break;case"grade":u="rs.ranking_points";break}if(d==="weekly")switch(i){case"overall":m=", (rs.total_level - rs.week_base_total_level) as weeklyScore",u="weeklyScore";break;case"power":m=", (rs.battle_power - rs.week_base_battle_power) as weeklyScore",u="weeklyScore";break;case"correct":case"grade":m=", ROUND(rs.ranking_points - rs.week_base_ranking_points, 1) as weeklyScore",u="weeklyScore";break;case"pokedex":m=", (rs.pokedex_count - rs.week_base_pokedex_count) as weeklyScore",u="weeklyScore";break;case"wild":m=", (rs.wild_win_streak - rs.week_base_wild_win_streak) as weeklyScore",u="weeklyScore";break}const f=i==="grade"&&l>=1&&l<=6?` AND rs.grade = ${l}`:"",w=d==="weekly"?` AND rs.week_start = '${c}'`:"";let g="";const y=[],b=`rs.user_id as userId, rs.display_name as displayName,
    ...
    ${m}`;if(n==="global"||t.role==="admin")g=`SELECT ${b}
    ...
    VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
  `).bind(d,t.id,a,Date.now(),String(s.todo||"").slice(0,500),String(s.why||"").slice(0,500),String(s.aim||"").slice(0,500),Number(s.minutes||0),String(s.endWeather||"sun"),String(s.weatherReason||"").slice(0,500),String(s.nextImprove||"").slice(0,500),s.restDay?1:0,Number(s.streakAfter||0),String(s.rewardKind||"coin"),Number(s.rewardCoins||0),Number(s.rewardShards||0),Number(s.bonusCoins||0),Number(s.bonusShards||0),i,String(s.selfStudyPlan||"").slice(0,500),String(s.weeklyPlan||"").slice(0,1e3),String(s.weeklyReflection||"").slice(0,1e3),String(s.workPhotoAnalysis||"").slice(0,500)).run(),e.json({ok:!0,id:d})});h.post("/api/homework/analyze-photo",async e=>{const t=e.get("user");if(!t||t.role!=="student")return o(e,403,"forbidden");const s=await e.req.formData().catch(()=>null);if(!s)return o(e,400,"invalid_form_data");const a=String(s.get("dayKey")||"").slice(0,10);if(!a)return o(e,400,"day_key_required");const n=s.get("photo");if(!n||!n.size)return o(e,400,"photo_required");if(n.size>5*1024*1024)return o(e,400,"photo_too_large_max_5mb");const r=new Uint8Array(await n.arrayBuffer());let i="";try{const l=await e.env.AI.run("@cf/meta/llama-3.2-11b-vision-instruct",{messages:[{role:"user",content:[{type:"text",text:"この画像は小学生の家庭学習の成果物です。何が写っているか、どんな学習をしたか、丁寧さや量、特徴を日本語で100文字以内で簡潔に説明してください。"},{type:"image",image:[...r]}]}],max_tokens:300});i=String(l.response||"").trim().slice(0,500)}catch{return o(e,500,"ai_analysis_failed")}i||(i="（画像の分析結果を取得できませんでした）");const d=await e.env.DB.prepare("SELECT id FROM homework_submissions WHERE user_id=? AND day_key=? LIMIT 1").bind(t.id,a).first();return d&&await e.env.DB.prepare("UPDATE homework_submissions SET work_photo_analysis=? WHERE id=?").bind(i,d.id).run(),e.json({ok:!0,analysis:i,saved:!!d})});h.put("/api/homework/submit",async e=>{var r;const t=e.get("user");if(!t||t.role!=="student")return o(e,403,"forbidden");const s=await e.req.json().catch(()=>null);if(!s)return o(e,400,"invalid_json");const a=String(s.dayKey||"").slice(0,10);return a?(r=(await e.env.DB.prepare(`
...
=== 児童の振り返り ===
${n.results.map((u,m)=>{const f=i[u.user_id]||[],w=f.length?f.map(y=>`  [${y.day_key}] ${y.todo||""}(${y.minutes||0}分) 先生:${y.teacher_comment||"なし"}`).join(`
`):"  なし",g=u.work_photo_analysis?`
  ...
  次どうする: ${u.next_improve||"未記入"}${g}
  過去の記録:
${w}`}).join(`

`)}`;try{const m=((await e.env.AI.run("@cf/meta/llama-3.1-8b-instruct",{messages:[{role:"user",content:l}],max_tokens:2e3})).response||"").trim();let f=[];try{const g=m.match(/\{[\s\S]*\}/);g&&(f=JSON.parse(g[0]).comments||[])}catch{f=m.split(`
`).filter(g=>g.match(/^\d+[\.\)]/)).map(g=>g.replace(/^\d+[\.\)]\s*/,"").trim())}const w=n.results.map((g,y)=>({id:g.id,name:g.name,dayKey:g.day_key,comment:(f[y]||"").slice(0,50)}));return e.json({ok:!0,comments:w})}catch(u){return o(e,500,"AI error: "+(u.message||String(u)))}});function J(e){const t=new Date,s=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()));s.setUTCDate(s.getUTCDate()+4-(s.getUTCDay()||7));const a=new Date(Date.UTC(s.getUTCFullYear(),0,1)),n=Math.ceil(((s.getTime()-a.getTime())/864e5+1)/7);return`${s.getUTCFullYear()}-W${String(n).padStart(2,"0")}`}function Ve(e){const t=e.match(/^(\d{4})-W(\d{2})$/);if(!t)return e;let s=parseInt(t[1]),a=parseInt(t[2]);return a--,a<1&&(s--,a=52),s+"-W"+String(a).padStart(2,"0")}h.post("/api/teacher/class/:classId/weekly-menu",async e=>{const t=e.get("user");if(!t||t.role!=="teacher"&&t.role!=="admin")return o(e,403,"forbidden");const s=e.req.param("classId");if(!(t.role==="admin"?await e.env.DB.prepare("SELECT id FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id FROM classes WHERE id=? AND teacher_id=? LIMIT 1").bind(s,t.id).first()))return o(e,404,"class_not_found");const r=await e.req.json().catch(()=>null);if(!r)return o(e,400,"invalid_json");const i=String(r.weekKey||J()).slice(0,8),d=String(r.kanjiPage||"").slice(0,100),l=String(r.keisanPage||"").slice(0,100),c=String(r.otherTasks||"").slice(0,500),u=["mon","tue","wed","thu","fri"],m=Array.isArray(r.activeDays)?r.activeDays.filter(w=>u.includes(w)):u,f=JSON.stringify(m);return await e.env.DB.prepare(`
  ...
  `).bind(s,i,d,l,c,tests,f,Date.now()).run(),e.json({ok:!0,weekKey:i})});h.get("/api/teacher/class/:classId/weekly-menu",async e=>{const t=e.get("user");if(!t||t.role!=="teacher"&&t.role!=="admin")return o(e,403,"forbidden");const s=e.req.param("classId");if(!(t.role==="admin"?await e.env.DB.prepare("SELECT id FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id FROM classes WHERE id=? AND teacher_id=? LIMIT 1").bind(s,t.id).first()))return o(e,404,"class_not_found");const r=e.req.query("weekKey")||J(),i=await e.env.DB.prepare("SELECT * FROM class_weekly_menu WHERE class_id=? AND week_key=? LIMIT 1").bind(s,r).first();return e.json({ok:!0,menu:i||null,weekKey:r})});h.get("/api/student/weekly-menu",async e=>{const t=e.get("user");if(!t)return o(e,403,"forbidden");const s=e.req.query("weekKey")||J(),a=await e.env.DB.prepare(`
    ...
    LIMIT 1
  `).bind(t.id,s).first();if(!a){const n=Ve(s),r=await e.env.DB.prepare(`
      SELECT cwm.kanji_page as kanjiPage, cwm.keisan_page as keisanPage,
             cwm.other_tasks as otherTasks, cwm.tests as tests, cwm.week_key as weekKey,
             cwm.active_days as activeDays
      FROM class_weekly_menu cwm
      ...
      WHERE cm.user_id = ? AND cwm.week_key = ?
      LIMIT 1
    `).bind(t.id,n).first();return e.json({ok:!0,menu:r||null,weekKey:s,published:!1,fallbackWeek:r?n:null})}return e.json({ok:!0,menu:a,weekKey:s,published:!0})});h.get("/api/student/weekly-plan-status",async e=>{const t=e.get("user");if(!t)return o(e,403,"forbidden");const s=e.req.query("weekKey")||J(),a=await e.env.DB.prepare(`
  ...
  `).bind(t.id,s).all();let f=0;c&&(f+=2);const w=Math.min(1,((n==null?void 0:n.cnt)||0)/5);f+=Math.round(w*3);const g=(m.results||[]).filter(b=>b.reason&&b.reason.length>0).length;if(f+=Math.min(6,g*2),u){let b=0;u.good_point&&u.good_point.length>=5&&(b+=1),u.improve_point&&u.improve_point.length>=5&&(b+=1),u.next_action&&(b+=1),f+=b}const y=Wt({streak:(l==null?void 0:l.streak)||0,thisWeekMin:(n==null?void 0:n.totalMin)||0,prevWeekMin:(r==null?void 0:r.totalMin)||0,thisWeekCount:(n==null?void 0:n.cnt)||0,thisWeekResults:i.results||[],prevWeekResults:d.results||[],selfRegScore:f,revisionCount:(c==null?void 0:c.revision_count)||0});return e.json({ok:!0,weekKey:s,homework:{thisWeek:{count:(n==null?void 0:n.cnt)||0,totalMin:(n==null?void 0:n.totalMin)||0,avgMin:Math.round((n==null?void 0:n.avgMin)||0)},prevWeek:{count:(r==null?void 0:r.cnt)||0,totalMin:(r==null?void 0:r.totalMin)||0,avgMin:Math.round((r==null?void 0:r.avgMin)||0)}},results:{thisWeek:(i.results||[]).map(b=>({unit:b.unit,rate:b.total>0?Math.round(b.correct_count/b.total*100):0,total:b.total})),prevWeek:(d.results||[]).map(b=>({unit:b.unit,rate:b.total>0?Math.round(b.correct_count/b.total*100):0,total:b.total}))},streak:(l==null?void 0:l.streak)||0,selfRegulation:{score:f,maxScore:14,planMade:!!c,revisionCount:(c==null?void 0:c.revision_count)||0,reflectionDone:!!u},feedback:y})});function Wt(e){const t=[];if(e.streak>=14?t.push("🔥 "+e.streak+"日連続提出！すごい継続力だね！この調子！"):e.streak>=7?t.push("⭐ 1週間連続で提出できたね！がんばってるね！"):e.streak>=3&&t.push("👍 "+e.streak+"日連続！いいリズムだよ！"),e.prevWeekMin>0&&e.thisWeekMin>0){const a=e.thisWeekMin-e.prevWeekMin,n=Math.round(a/e.prevWeekMin*100);n>=20?t.push("📈 先週より学習時間が"+n+"%アップ！がんばりが見えるよ！"):n<=-20&&e.thisWeekCount>=3&&t.push("💪 今週は少し時間が短めだけど、ちゃんと取り組めてるね！")}const s={};for(const a of e.prevWeekResults)s[a.unit]=a.total>0?Math.round(a.correct_count/a.total*100):0;for(const a of e.thisWeekResults){const n=a.total>0?Math.round(a.correct_count/a.total*100):0,r=s[a.unit]||0;n>=r+15&&a.total>=3&&t.push("🎯 "+a.unit+"の正答率が先週より"+(n-r)+"%アップ！力がついてきたね！"),n<50&&a.total>=5&&t.push("📝 "+a.unit+"はもう少し練習してみよう。コツコツやれば必ず伸びるよ！")}return e.revisionCount>=2?t.push("🔄 計画を"+e.revisionCount+"回見直せたね！自分で考えて調整できるのはすごいことだよ！"):e.revisionCount===1&&t.push("🔄 計画を見直して修正できたね！これが「自分で学ぶ力」だよ！"),e.selfRegScore>=10&&t.push("🏆 自己調整スコアが"+e.selfRegScore+"点！自分の学びをしっかりコントロールできてるね！"),t.length===0&&t.push("🌟 今週も家庭学羒をがんばろう！少しずつで大丈夫だよ！"),t.slice(0,4)}h.get("/api/teacher/class-analytics",async e=>{const t=e.get("user");if(!t||t.role!=="teacher"&&t.role!=="admin")return o(e,403,"forbidden");const s=e.req.query("classId");if(!s)return o(e,400,"classId required");const a=e.req.query("weekKey")||J(),n=Ve(a);if(!(t.role==="admin"?await e.env.DB.prepare("SELECT id FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id FROM classes WHERE id=? AND teacher_id=?").bind(s,t.id).first()))return o(e,404,"class_not_found");const i=await e.env.DB.prepare(`
    SELECT u.id, u.name, u.grade, u.class_name as className
  ...
  `).bind(s,a).all(),u=await e.env.DB.prepare(`
    ...
    WHERE sr.week_key=?
  `).bind(s,a).all(),m={};for(const g of l.results||[])m[g.user_id]=g;const f={};for(const g of d.results||[])f[g.user_id]||(f[g.user_id]={cnt:0,totalMin:0}),f[g.user_id].cnt++,f[g.user_id].totalMin+=g.minutes||0;const w=[];for(const g of i.results||[]){const y=f[g.id],b=m[g.id];b&&b.cnt>=3&&(!y||y.cnt<=1)&&w.push({userId:g.id,name:g.name,type:"submission_drop",detail:"先週"+b.cnt+"回→今週"+((y==null?void 0:y.cnt)||0)+"回に減少"}),b&&b.totalMin>=60&&y&&y.totalMin<b.totalMin*.5&&w.push({userId:g.id,name:g.name,type:"time_drop",detail:"学習時間が先週の半分以下"}),!y&&(i.results||[]).length>0&&w.push({userId:g.id,name:g.name,type:"no_submission",detail:"今週まだ提出なし"})}return e.json({ok:!0,weekKey:a,members:i.results,homework:d.results,plans:c.results,reflections:u.results,alerts:w})});h.get("/api/teacher/auto-feedback",async e=>{const t=e.get("user");if(!t||t.role!=="teacher"&&t.role!=="admin")return o(e,403,"forbidden");const s=e.req.query("classId");if(!s)return o(e,400,"classId required");const a=e.req.query("weekKey")||J(),n=Ve(a);if(!(t.role==="admin"?await e.env.DB.prepare("SELECT id FROM classes WHERE id=? LIMIT 1").bind(s).first():await e.env.DB.prepare("SELECT id FROM classes WHERE id=? AND teacher_id=?").bind(s,t.id).first()))return o(e,404,"class_not_found");const i=await e.env.DB.prepare(`
  ...
  `).bind(s).all(),d=[];for(const l of i.results||[]){let c={cnt:0,totalMin:0},u={cnt:0,totalMin:0};try{c=await e.env.DB.prepare(`
    ...
    `).bind(l.id).first()}catch{}let f={results:[]};try{f=await e.env.DB.prepare(`
    ...
    `).bind(l.id,a).all()}catch{}let w={results:[]};try{w=await e.env.DB.prepare(`
      SELECT unit, COUNT(*) as total, SUM(CASE WHEN correct=1 THEN 1 ELSE 0 END) as correct_count
      FROM learning_results WHERE user_id=? AND week_key=? GROUP BY unit
    `).bind(l.id,n).all()}catch{}let g=null;try{g=await e.env.DB.prepare(`
      SELECT revision_count FROM student_weekly_plans WHERE user_id=? AND week_key=?
    `).bind(l.id,a).first()}catch{}const y=Wt({streak:(m==null?void 0:m.streak)||0,thisWeekMin:(c==null?void 0:c.totalMin)||0,prevWeekMin:(u==null?void 0:u.totalMin)||0,thisWeekCount:(c==null?void 0:c.cnt)||0,thisWeekResults:f.results||[],prevWeekResults:w.results||[],selfRegScore:0,revisionCount:(g==null?void 0:g.revision_count)||0});d.push({userId:l.id,name:l.name,messages:y})}return e.json({ok:!0,feedbackList:d,weekKey:a})});h.get("/api/teacher/weekly-plan/:id/revisions",async e=>{const t=e.get("user");if(!t||t.role!=="teacher"&&t.role!=="admin")return o(e,403,"forbidden");const s=e.req.param("id");if(!await e.env.DB.prepare(`
...
`).filter(w=>w.match(/^\d+[\.\)]/)).map(w=>w.replace(/^\d+[\.\)]\s*/,"").trim())}const f=r.results.map((w,g)=>({id:w.id,name:w.name,comment:(m[g]||"").slice(0,50)}));return e.json({ok:!0,comments:f})}catch(c){return o(e,500,"AI error: "+(c.message||String(c)))}});function j(e){const t=e.get("user");return t||null}function Ke(){const e="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let t="";const s=new Uint8Array(6);crypto.getRandomValues(s);for(let a=0;a<6;a++)t+=e[s[a]%e.length];return t}h.post("/api/battle/create",async e=>{const t=j(e);if(!t)return o(e,401,"unauthorized");const s=await e.req.json().catch(()=>null);if(!s)return o(e,400,"invalid_json");const a=JSON.stringify(s.party||[]),n=String(s.name||"プレイヤー").slice(0,20),r=String(s.area||"rounding").slice(0,40),i=String(s.battleMode||"normal").slice(0,10);await e.env.DB.prepare("DELETE FROM battle_rooms WHERE host_user_id=? AND status='waiting'").bind(t.id).run();let d=Ke();for(let l=0;l<5&&await e.env.DB.prepare("SELECT id FROM battle_rooms WHERE id=?").bind(d).first();l++)d=Ke();return await e.env.DB.prepare(`
  ...
  `).bind(s,c).all(),f=m.results.find(D=>D.user_id===n.host_user_id),w=m.results.find(D=>D.user_id===n.guest_user_id);let g=n.host_score,y=n.guest_score,b=n.host_hp,v=n.guest_hp,_=!1,x=n.status,T=n.winner;if(f&&w){_=!0;const D=!!f.is_correct,H=!!w.is_correct;D&&!H?(g++,v=Math.max(0,v-20)):!D&&H&&(y++,b=Math.max(0,b-20));const A=c+1;(b<=0||v<=0||A>=5)&&(x="finished",g>y?T="host":y>g?T="guest":T="draw"),await e.env.DB.prepare(`
      UPDATE battle_rooms
      SET host_score=?, guest_score=?, host_hp=?, guest_hp=?, status=?, winner=?, updated_at=datetime('now')
      WHERE id=?
    `).bind(g,y,b,v,x,T,s).run()}return e.json({ok:!0,bothAnswered:_,hostScore:g,guestScore:y,hostHp:b,guestHp:v,status:x,winner:T})});h.post("/api/battle/leave/:roomId",async e=>{const t=j(e);if(!t)return o(e,401,"unauthorized");const s=e.req.param("roomId").toUpperCase(),a=await e.env.DB.prepare("SELECT * FROM battle_rooms WHERE id=? LIMIT 1").bind(s).first();return a?(a.host_user_id===t.id?await e.env.DB.prepare("DELETE FROM battle_rooms WHERE id=?").bind(s).run():await e.env.DB.prepare(`
  ...
  `).bind(s,i).all(),l=n?"host":"guest",c=n?a.guest_party_json?JSON.parse(a.guest_party_json):null:JSON.parse(a.host_party_json||"[]");return e.json({ok:!0,room:{id:a.id,status:a.status,battleType:a.battle_type,area:a.host_area,hostName:a.host_name,guestName:a.guest_name,hostHp:a.host_hp,guestHp:a.guest_hp,hostReady:!!a.host_ready,guestReady:!!a.guest_ready,winner:a.winner,myRole:l,opponentParty:c},events:d.results})});h.post("/api/rt/ready/:roomId",async e=>{const t=j(e);if(!t)return o(e,401,"unauthorized");const s=e.req.param("roomId").toUpperCase(),a=await e.env.DB.prepare("SELECT * FROM rt_rooms WHERE id=? LIMIT 1").bind(s).first();if(!a)return o(e,404,"room_not_found");const n=a.host_user_id===t.id,r=a.guest_user_id===t.id;if(!n&&!r)return o(e,403,"not_a_participant");n?await e.env.DB.prepare("UPDATE rt_rooms SET host_ready=1, updated_at=datetime('now') WHERE id=?").bind(s).run():await e.env.DB.prepare("UPDATE rt_rooms SET guest_ready=1, updated_at=datetime('now') WHERE id=?").bind(s).run();const i=await e.env.DB.prepare("SELECT * FROM rt_rooms WHERE id=? LIMIT 1").bind(s).first();return i&&i.host_ready&&i.guest_ready&&(i.status==="ready"||i.status==="waiting")&&await e.env.DB.prepare("UPDATE rt_rooms SET status='playing', updated_at=datetime('now') WHERE id=?").bind(s).run(),e.json({ok:!0})});h.post("/api/rt/damage/:roomId",async e=>{const t=j(e);if(!t)return o(e,401,"unauthorized");if(!Ht(`rtdmg:${t.id}`,20,10))return o(e,429,"too_many_requests");const s=e.req.param("roomId").toUpperCase(),a=await e.req.json().catch(()=>null);if(!a)return o(e,400,"invalid_json");const n=await e.env.DB.prepare("SELECT * FROM rt_rooms WHERE id=? LIMIT 1").bind(s).first();if(!n)return o(e,404,"room_not_found");if(n.status!=="playing")return o(e,409,"not_playing");const r=n.host_user_id===t.id,i=n.guest_user_id===t.id;if(!r&&!i)return o(e,403,"not_a_participant");const d=Math.max(0,Math.min(500,Number(a.damage||0)));if(!Number.isFinite(d))return o(e,400,"invalid_damage");const l=Math.max(0,Math.min(9999,Math.floor(Number(a.monsterId||0)))),c=a.meta?JSON.stringify(a.meta).slice(0,500):null,m=["damage","faint","win","lose","self_damage","gym_ready","egg_battle"].includes(String(a.eventType))?String(a.eventType):"damage",w=(await e.env.DB.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?)
  `).bind(s,t.id,m,d,l,c).run()).meta.last_row_id;let g=n.host_hp,y=n.guest_hp;m==="self_damage"?r?g=Math.max(0,g-d):y=Math.max(0,y-d):r?y=Math.max(0,y-d):g=Math.max(0,g-d);let b=n.status,v=n.winner;return m==="win"?(b="finished",v=r?"host":"guest"):m==="draw"&&(b="finished",v="draw"),await e.env.DB.prepare(`
    UPDATE rt_rooms SET host_hp=?, guest_hp=?, status=?, winner=?, updated_at=datetime('now') WHERE id=?
  `).bind(g,y,b,v,s).run(),e.json({ok:!0,eventId:w,hostHp:g,guestHp:y})});h.post("/api/rt/leave/:roomId",async e=>{const t=j(e);if(!t)return o(e,401,"unauthorized");const s=e.req.param("roomId").toUpperCase(),a=await e.env.DB.prepare("SELECT * FROM rt_rooms WHERE id=? LIMIT 1").bind(s).first();return a?(a.host_user_id===t.id?await e.env.DB.prepare("DELETE FROM rt_rooms WHERE id=?").bind(s).run():await e.env.DB.prepare(`
